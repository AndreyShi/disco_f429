    ...
    sliderValueChangedCallback(this, &MainViewBase::sliderValueChangedCallbackHandler)
{
    ...
    graphMajorXAxisLabel.setLabelTypedText(touchgfx::TypedText(T___SINGLEUSE_17Y0));
    ...
    graphMajorYAxisLabel.setLabelTypedText(touchgfx::TypedText(T___SINGLEUSE_N8JJ));
